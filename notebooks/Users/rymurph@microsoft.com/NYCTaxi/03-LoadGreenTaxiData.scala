...
val greenTripSchema5 = StructType(Array(
...
val srcFileNamePrefix = "green_tripdata_" 
...
var taxiSchema = greenTripSchema5
...
for (j <- 2017 to 2017)
  {
    ...
    for (i <- 1 to 6) 
    {
      ...
      */
      ...
      val greenTaxiDF = sqlContext.read.format("csv")
                                .option("header", "true")
                                .schema(taxiSchema)
                                .option("delimiter",",")
      ...
      println("recordCount = " + greenTaxiDF.count)
      ...
      if(j == 2017)
      {
        ...
        println("====================================================================================")
        greenTaxiFormattedDF.printSchema
        println("recordCount = " + greenTaxiFormattedDF.count)
